---
title: "Building Web-enabled Visual Analytics Application with Shiny: Shiny basic"
subtitle: ""  
...
::: columns
::: {.column width="50%"}
It allows R users: - to build and share highly interactive web-enabled applications without having to invest significant among of time and efforts to master core web design technologies such as html5, Javascript and CSS.
...
#| eval: false 
#| echo: false 
renderthis::to_pdf(from = "https://isss608-ay2022-23jan.netlify.app/lesson/lesson01/Lesson01-VAA.html")
```
